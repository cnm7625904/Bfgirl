...
import com.bfgirl.administrator.bfgirl.Adapter.WenYiAdapter;
...
public class WenyiFragment extends com.trello.rxlifecycle.components.support.RxFragment {
    private TwinklingRefreshLayout refreshLayout;
    private boolean mIsLoadMore = true;
    private LinearLayoutManager linearLayoutManager;
    private int num = 1;
    private List<String> mDatas;
    private WenYiAdapter mAdapter;
    private RecyclerView rv;
    private Map<String, Object> map;
    public static WenyiFragment getInstance() {
        WenyiFragment sf = new WenyiFragment();
        return sf;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.wenyifragment, null, false);
        initViews(v);
        return v;
    }
    private void initViews(View v) {
        refreshLayout = (TwinklingRefreshLayout) v.findViewById(R.id.twwy);
        mDatas = new ArrayList<>();
        rv = (RecyclerView) v.findViewById(R.id.rvwy);
        mAdapter = new WenYiAdapter(rv);
        ...
        mAdapter.setOnItemClickListener(new AbsRecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, AbsRecyclerViewAdapter.ClickableViewHolder holder) {
                ActivityOptionsCompat aop = ActivityOptionsCompat.makeSceneTransitionAnimation(getActivity(),
                        holder.getParentView().findViewById(R.id.wenyi_img), "123");
